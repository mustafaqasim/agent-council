...
For a shared-contract or shared-interface change, route R3 and require ultimate design review, integration evidence across the affected consumers, and fault evidence. Unit evidence for one component does not satisfy that boundary.
